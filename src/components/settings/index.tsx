...
import {Container, Wrapper,List,Item,IconContainer,ButtonLink} from "./styles/settings";
...
Settings.IconContainer = function SettingsIconContainer({children,...rest}: iProps) {
    return <IconContainer {...rest}>{children}</IconContainer>
}

/* Settings.ButtonLink = function SettingsButtonLink({children,...rest}: iProps) {
